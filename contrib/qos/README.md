...
This means one can have an always-on patentd instance running, and another local patentd/patent-qt instance which connects to this node and receives blocks from it.
