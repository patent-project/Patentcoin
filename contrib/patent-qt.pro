...
RESOURCES += src/qt/patent.qrc src/qt/patent_locale.qrc

TRANSLATIONS += src/qt/locale/patent_bg.ts \
                src/qt/locale/patent_de.ts \
                src/qt/locale/patent_en.ts \
                src/qt/locale/patent_es.ts \
                src/qt/locale/patent_fi.ts \
                src/qt/locale/patent_fr.ts \
                src/qt/locale/patent_it.ts \
                src/qt/locale/patent_ja.ts \
                src/qt/locale/patent_pl.ts \
                src/qt/locale/patent_pt.ts \
                src/qt/locale/patent_ru.ts \
                src/qt/locale/patent_sk.ts \
                src/qt/locale/patent_sv.ts \
                src/qt/locale/patent_vi.ts \
                src/qt/locale/patent_zh_CN.ts \
                src/qt/locale/patent_zh_TW.ts
