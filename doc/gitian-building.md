...
*Setup instructions for a gitian build of Patent using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Patent
...
- [Building Patent](#building-digiwage)
...
To build Patent (for Linux, OSX and Windows) just follow the steps under 'perform
