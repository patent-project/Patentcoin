TOR SUPPORT IN Patent
=======================

It is possible to run Patent as a Tor hidden service, and connect to such services.
...
Run Patent behind a Tor proxy
----------------------------------

The first step is running Patent behind a Tor proxy. This will already make all
...
List of known Patent Tor relays
------------------------------------
```
