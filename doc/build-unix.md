UNIX BUILD NOTES
====================
Some notes on how to build Patent in Unix.
...
memory available when compiling Patent Core. With 512MB of memory or less
...
If you want to build Patent-Qt, make sure that the required packages for Qt development
...
# Configure Patent Core to use our own-built instance of BDB
cd $Patent_ROOT
...
Security
--------
To help make your Patent installation more secure by making certain attacks impossible to
