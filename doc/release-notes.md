Patent Core version 2.3.1 is now available from:
...
Patent Core is extensively tested on multiple operating systems using
...
Patent Core should also work on most other Unix-like systems but is not
...
[
  {
    ...
    "PaymentAddress": "xxxx",     (string) Patent address of payment
