...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PATENT features */
        {"patent", "masternode", &masternode, true, true, false},
        {"patent", "masternodelist", &masternodelist, true, true, false},
        {"patent", "mnbudget", &mnbudget, true, true, false},
        {"patent", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"patent", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"patent", "mnsync", &mnsync, true, true, false},
        {"patent", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"patent", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use patentd, or the -server option to patent-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> patent-cli " + methodname + " " + args + "\n";
}
