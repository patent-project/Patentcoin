...
#if defined(NDEBUG)
#error "Patent cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Patent Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
  ...
  if( nHeight >= 1 && nHeight <= 10000 ) {
          ...
          nSubsidy = 4 * COIN;
      } else if (nHeight >= 80001 && nHeight <= 573000) {
          nSubsidy = 5 * COIN;
