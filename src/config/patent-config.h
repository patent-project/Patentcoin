/* src/config/patent-config.h.  Generated from patent-config.h.in by configure.  */
/* src/config/patent-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef PATENT_CONFIG_H

#define PATENT_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://patent.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Patent Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Patent Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "patent"
