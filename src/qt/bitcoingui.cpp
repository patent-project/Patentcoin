                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Patent-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Patent address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and patent: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Patent Core"), this);
    aboutAction->setStatusTip(tr("Show information about Patent Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Patent"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Patent addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Patent addresses"));
    ...
    openAction->setStatusTip(tr("Open a Patent: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Patent Core help message to get a list with possible Patent command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Patent Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Patent network", "", count));
}
...
{
    QString strTitle = tr("Patent Core"); // default title
