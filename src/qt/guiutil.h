...
/** Utility functions used by the PATENT Qt UI.
 */
namespace GUIUtil
{
...
// Render PATENT addresses in monospace font
...
// Parse "patent:" URI into recipient object, return true on successful parsing
